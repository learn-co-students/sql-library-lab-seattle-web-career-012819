CREATE TABLE characters(id INTEGER PRIMARY KEY,name TEXT, motto TEXT, species TEXT, series_id INTERGER, author_id INTERGER); 
CREATE TABLE books(id INTEGER PRIMARY KEY,title TEXT, year INTEGER, series_id INTERGER); 
